...
// Get dmtg and master info
$sql = "SELECT c.dmtg, m.manv, m.mapb, m.ngct 
        FROM bhld_ctctu c 
...
// Calculate using ALLOCATE logic
$ngct_next_allocate = date('Y-m-d', strtotime($ngct . ' + ' . $dmtg . ' month'));
...
// Calculate using DEALLOCATE logic (same)
$ngct_next_deallocate = date('Y-m-d', strtotime($ngct . ' + ' . $dmtg . ' month'));
